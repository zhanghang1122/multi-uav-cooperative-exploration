#!/usr/bin/env python3
"""Turn FUEL's rendered depth and sensor pose into TF-correct local clouds.

This is an independent mapping adapter. It subscribes only to the same rendered
depth and pose streams used by FUEL; it never publishes a planning target.
"""
...
class FuelDepthToCloud:
    ...
    def depth_callback(self, message):
        ...
        cloud = self.point_cloud2.create_cloud_xyz32(header, points)
