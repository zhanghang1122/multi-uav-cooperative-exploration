...
This repository does not vendor the upstream planners. The wrappers under
`demos/` expect separate upstream workspaces.

| Project | Upstream | License | Used by |
|---|---|---|---|
| Prometheus | https://gitee.com/amovlab/Prometheus | Upstream license | Demo 1 |
| PX4 Autopilot | https://github.com/PX4/PX4-Autopilot | BSD-3-Clause | Demo 1 |
